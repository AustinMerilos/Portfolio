...
export const projectData = [
  ...
  {
    title: "LiteraryLane",
    description: `Completed this project for Wes Bos's Fullstack Advanced React & GraphQL. It uses GraphQL API with Node.js on the backend and Next.Js with React & Apollo on the front end, I also added a few of my styles and components for this online book store.`,
  ...
  },
  {
    title: "Homestead",
    description:
      "This project was built from scratch using React and typescript to create a real estate website with a search bar, image carousel, and navigation bar. Styling is used with Material UI and style components. The data used is from the Bayut API from Rapidapi.",
